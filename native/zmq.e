...
__attribute__ ((visibility("default"))) int zmq_ctx_shutdown (void *context);
...
__attribute__ ((visibility("default"))) int zmq_msg_get (zmq_msg_t *msg, int property);
__attribute__ ((visibility("default"))) int zmq_msg_set (zmq_msg_t *msg, int property, int optval);
__attribute__ ((visibility("default"))) const char *zmq_msg_gets (zmq_msg_t *msg, const char *property);
# 422 "zmq.h"
...
__attribute__ ((visibility("default"))) int zmq_proxy_steerable (void *frontend, void *backend, void *capture, void *control);
...
__attribute__ ((visibility("default"))) int zmq_has (const char *capability);
...
__attribute__ ((visibility("default"))) char *zmq_z85_encode (char *dest, const uint8_t *data, size_t size);


__attribute__ ((visibility("default"))) uint8_t *zmq_z85_decode (uint8_t *dest, const char *string);



__attribute__ ((visibility("default"))) int zmq_curve_keypair (char *z85_public_key, char *z85_secret_key);



__attribute__ ((visibility("default"))) int zmq_curve_public (char *z85_public_key, const char *z85_secret_key);





__attribute__ ((visibility("default"))) void *zmq_atomic_counter_new (void);
__attribute__ ((visibility("default"))) void zmq_atomic_counter_set (void *counter, int value);
__attribute__ ((visibility("default"))) int zmq_atomic_counter_inc (void *counter);
__attribute__ ((visibility("default"))) int zmq_atomic_counter_dec (void *counter);
__attribute__ ((visibility("default"))) int zmq_atomic_counter_value (void *counter);
__attribute__ ((visibility("default"))) void zmq_atomic_counter_destroy (void **counter_p);
# 530 "zmq.h"
__attribute__ ((visibility("default"))) void *zmq_stopwatch_start (void);



__attribute__ ((visibility("default"))) unsigned long zmq_stopwatch_stop (void *watch_);


__attribute__ ((visibility("default"))) void zmq_sleep (int seconds_);

typedef void (zmq_thread_fn) (void*);


__attribute__ ((visibility("default"))) void *zmq_threadstart (zmq_thread_fn* func, void* arg);


__attribute__ ((visibility("default"))) void zmq_threadclose (void* thread);
